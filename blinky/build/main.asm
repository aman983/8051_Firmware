...
00135$:
	jnc	00101$
;	main.c:16: GPIO_PORT_Write(&LED1, 1 << i); 
	mov	ar6,r7
	mov	b,r6
	inc	b
	mov	a,#0x01
...
;	main.c:14: for (unsigned char i = 0; i < 8; i++) {
	...
	sjmp	00107$
00101$:
;	main.c:20: for (unsigned char i = 0; i < 8; i++) {
	mov	r7,#0x00
00110$:
	cjne	r7,#0x08,00140$
00140$:
	jnc	00115$
;	main.c:22: GPIO_PORT_Write(&LED1, 0b10000000 >> i); 
	mov	b,r7
	inc	b
	mov	r5,#0x80
	clr	a
