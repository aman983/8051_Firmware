      ...
      000083 E4               [12]  277 	clr	a
      000084 F5 32            [12]  278 	mov	_sys_tick_ms,a
      000086 F5 33            [12]  279 	mov	(_sys_tick_ms + 1),a
      000088 F5 34            [12]  280 	mov	(_sys_tick_ms + 2),a
      00008A F5 35            [12]  281 	mov	(_sys_tick_ms + 3),a
                                    282 ;--------------------------------------------------------
                                    283 ; Home
                                    284 ;--------------------------------------------------------
                                    285 	.area HOME    (CODE)
      ...
      000A65                        298 _timer1_ISR:
                           ...
                           000001   305 	ar1 = 0x01
                           000000   306 	ar0 = 0x00
      000A65 C0 E0            [24]  307 	push	acc
      000A67 C0 07            [24]  308 	push	ar7
      000A69 C0 06            [24]  309 	push	ar6
      000A6B C0 05            [24]  310 	push	ar5
      000A6D C0 04            [24]  311 	push	ar4
      000A6F C0 D0            [24]  312 	push	psw
      000A71 75 D0 00         [24]  313 	mov	psw,#0x00
                                    314 ;	../HAL/Sys_tick.c:9: TH1 = TH1_INIT;
      000A74 75 8D FC         [24]  315 	mov	_TH1,#0xfc
                                    316 ;	../HAL/Sys_tick.c:10: TL1 = TL1_INIT;
      000A77 75 8B 67         [24]  317 	mov	_TL1,#0x67
                                    318 ;	../HAL/Sys_tick.c:11: sys_tick_ms++;
      000A7A AC 32            [24]  319 	mov	r4,_sys_tick_ms
      000A7C AD 33            [24]  320 	mov	r5,(_sys_tick_ms + 1)
      000A7E AE 34            [24]  321 	mov	r6,(_sys_tick_ms + 2)
      000A80 AF 35            [24]  322 	mov	r7,(_sys_tick_ms + 3)
      000A82 74 01            [12]  323 	mov	a,#0x01
      000A84 2C               [12]  324 	add	a,r4
      000A85 F5 32            [12]  325 	mov	_sys_tick_ms,a
      000A87 E4               [12]  326 	clr	a
      000A88 3D               [12]  327 	addc	a,r5
      000A89 F5 33            [12]  328 	mov	(_sys_tick_ms + 1),a
      000A8B E4               [12]  329 	clr	a
      000A8C 3E               [12]  330 	addc	a,r6
      000A8D F5 34            [12]  331 	mov	(_sys_tick_ms + 2),a
      000A8F E4               [12]  332 	clr	a
      000A90 3F               [12]  333 	addc	a,r7
      000A91 F5 35            [12]  334 	mov	(_sys_tick_ms + 3),a
                                    335 ;	../HAL/Sys_tick.c:12: }
      000A93 D0 D0            [24]  336 	pop	psw
      000A95 D0 04            [24]  337 	pop	ar4
      000A97 D0 05            [24]  338 	pop	ar5
      000A99 D0 06            [24]  339 	pop	ar6
      000A9B D0 07            [24]  340 	pop	ar7
      000A9D D0 E0            [24]  341 	pop	acc
      000A9F 32               [24]  342 	reti
