      ...
      000060 F5 2E            [12]  278 	mov	_sys_tick_ms,a
      000062 F5 2F            [12]  279 	mov	(_sys_tick_ms + 1),a
      000064 F5 30            [12]  280 	mov	(_sys_tick_ms + 2),a
      000066 F5 31            [12]  281 	mov	(_sys_tick_ms + 3),a
                                    282 ;--------------------------------------------------------
                                    283 ; Home
                                    284 ;--------------------------------------------------------
                                    285 	.area HOME    (CODE)
      ...
      0009EE                        298 _timer1_ISR:
                           ...
                           000001   305 	ar1 = 0x01
                           000000   306 	ar0 = 0x00
      0009EE C0 E0            [24]  307 	push	acc
      0009F0 C0 07            [24]  308 	push	ar7
      0009F2 C0 06            [24]  309 	push	ar6
      0009F4 C0 05            [24]  310 	push	ar5
      0009F6 C0 04            [24]  311 	push	ar4
      0009F8 C0 D0            [24]  312 	push	psw
      0009FA 75 D0 00         [24]  313 	mov	psw,#0x00
                                    314 ;	../HAL/Sys_tick.c:9: TH1 = TH1_INIT;
      0009FD 75 8D FC         [24]  315 	mov	_TH1,#0xfc
                                    316 ;	../HAL/Sys_tick.c:10: TL1 = TL1_INIT;
      000A00 75 8B 67         [24]  317 	mov	_TL1,#0x67
                                    318 ;	../HAL/Sys_tick.c:11: sys_tick_ms++;
      000A03 AC 2E            [24]  319 	mov	r4,_sys_tick_ms
      000A05 AD 2F            [24]  320 	mov	r5,(_sys_tick_ms + 1)
      000A07 AE 30            [24]  321 	mov	r6,(_sys_tick_ms + 2)
      000A09 AF 31            [24]  322 	mov	r7,(_sys_tick_ms + 3)
      000A0B 74 01            [12]  323 	mov	a,#0x01
      000A0D 2C               [12]  324 	add	a,r4
      000A0E F5 2E            [12]  325 	mov	_sys_tick_ms,a
      000A10 E4               [12]  326 	clr	a
      000A11 3D               [12]  327 	addc	a,r5
      000A12 F5 2F            [12]  328 	mov	(_sys_tick_ms + 1),a
      000A14 E4               [12]  329 	clr	a
      000A15 3E               [12]  330 	addc	a,r6
      000A16 F5 30            [12]  331 	mov	(_sys_tick_ms + 2),a
      000A18 E4               [12]  332 	clr	a
      000A19 3F               [12]  333 	addc	a,r7
      000A1A F5 31            [12]  334 	mov	(_sys_tick_ms + 3),a
                                    335 ;	../HAL/Sys_tick.c:12: }
      000A1C D0 D0            [24]  336 	pop	psw
      000A1E D0 04            [24]  337 	pop	ar4
      000A20 D0 05            [24]  338 	pop	ar5
      000A22 D0 06            [24]  339 	pop	ar6
      000A24 D0 07            [24]  340 	pop	ar7
      000A26 D0 E0            [24]  341 	pop	acc
      000A28 32               [24]  342 	reti
